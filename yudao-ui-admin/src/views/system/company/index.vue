  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="公司名称" prop="phone">
        <el-input v-model="queryParams.phone" placeholder="请输入公司名称" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="公司编码(用于认证)" prop="code">
        <el-input v-model="queryParams.code" placeholder="请输入公司编码(用于认证)" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="公司名称" align="center" prop="phone" />
      <el-table-column label="公司编码(用于认证)" align="center" prop="code" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="公司编码(用于认证)" prop="code">
          <el-input v-model="form.code" placeholder="请输入公司编码(用于认证)" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        phone: [{ required: true, message: "公司名称不能为空", trigger: "blur" }],
        code: [{ required: true, message: "公司编码(用于认证)不能为空", trigger: "blur" }],
      }
    };
  },
  created() {
  ...
  methods: {
    ...
    handleDelete(row) {
      const id = row.id;
      this.$modal.confirm('是否确认删除公司编号为"' + id + '"的数据项?').then(function() {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有公司数据项?').then(() => {
          ...
          this.$download.excel(response, '公司.xls');
