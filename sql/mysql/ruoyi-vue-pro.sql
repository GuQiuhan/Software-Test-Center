...
CREATE TABLE `bpm_task_ext`  (
  ...
  `end_time` TIMESTAMP NULL DEFAULT NULL COMMENT '任务的结束时间',
  `process_instance_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流程实例的编号',
  `process_definition_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流程定义的编号',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `pay_notify_task`  (
  ...
  `next_notify_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '下一次通知时间',
  `last_execute_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次执行时间',
...
CREATE TABLE `pay_order`  (
  ...
  `success_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '订单支付成功时间',
  `notify_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '订单支付通知时间',
...
CREATE TABLE `pay_refund`  (
  ...
  `expire_time` TIMESTAMP NULL DEFAULT NULL COMMENT '退款失效时间',
  `success_time` TIMESTAMP NULL DEFAULT NULL COMMENT '退款成功时间',
  `notify_time` TIMESTAMP NULL DEFAULT NULL COMMENT '退款通知时间',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `system_operate_log`  (
  ...
  `start_time` TIMESTAMP NOT NULL COMMENT '操作时间',
  `duration` int NOT NULL COMMENT '执行时长',
  `result_code` int NOT NULL DEFAULT 0 COMMENT '结果码',
  `result_msg` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '结果提示',
...
CREATE TABLE `system_user_session`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户编号',
  `user_type` tinyint NOT NULL DEFAULT 0 COMMENT '用户类型',
  `session_timeout` TIMESTAMP NOT NULL COMMENT '会话超时时间',
