...
CREATE TABLE IF NOT EXISTS "system_delegation" (
                                                   ...
                                                   "table3_id" varchar,
                                                   "url" varchar,
                                                   "market_dept_staff_id" bigint,
                                                   "testing_dept_staff_id" bigint,
                                                   "market_remark" varchar,
                                                   "testing_remark" varchar,
                                                   "table14_id" varchar,
                                                   "offer_id" varchar,
                                                   "offer_remark" varchar,
                                                   "contract_id" bigint,
                                                   "sample_id" bigint,
                                                   "solution_id" bigint,
                                                   "report_id" bigint,
                                                   "state" int NOT NULL,
                                                   "cancel_remark" varchar,
                                                   "creator" varchar DEFAULT '',
                                                   "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                                   "updater" varchar DEFAULT '',
                                                   "update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "system_operation" (
                                                  "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS "system_report" (
                                               ...
                                               "table9_id" varchar,
                                               "table11_id" varchar,
                                               "testing_dept_manager_id" bigint,
                                               "manager_remark" varchar,
                                               "table10_id" varchar,
                                               "signatory_remark" varchar,
                                               "signatory_id" bigint,
                                               "client_remark" varchar,
                                               "creator" varchar DEFAULT '',
                                               "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
